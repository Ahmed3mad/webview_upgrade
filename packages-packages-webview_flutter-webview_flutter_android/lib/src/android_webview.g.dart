...
class WebResourceRequestData {
  ...
  static WebResourceRequestData decode(Object result) {
    ...
    return WebResourceRequestData(
      ...
      method: (result as List<Object>)[4] as String,
      requestHeaders:
          ((result as List<Object>)[5] as Map<Object, Object>).cast<String, String>(),
    );
  }
}
...
class WebResourceErrorData {
  ...
  static WebResourceErrorData decode(Object result) {
    ...
    return WebResourceErrorData(
      errorCode: (result as List<Object>)[0] as int,
      description: (result as List<Object>)[1] as String,
    );
  }
}
...
class WebViewPoint {
  ...
  static WebViewPoint decode(Object result) {
    result as List<Object>;
    return WebViewPoint(
      x: (result as List<Object>)[0] as int,
      y: (result as List<Object>)[1] as int,
    );
  }
}
